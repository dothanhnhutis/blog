    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset=".01" stopColor="#C3D2C3" stopOpacity=".05"></stop>
          <stop offset=".03" stopColor="#C3D2C3" stopOpacity=".3"></stop>
          <stop offset=".06" stopColor="#C3D2C3" stopOpacity=".51"></stop>
          <stop offset=".09" stopColor="#C3D2C3" stopOpacity=".69"></stop>
          <stop offset=".12" stopColor="#C3D2C3" stopOpacity=".83"></stop>
          <stop offset=".15" stopColor="#C3D2C3" stopOpacity=".92"></stop>
          <stop offset=".18" stopColor="#C3D2C3" stopOpacity=".98"></stop>
          <stop offset=".21" stopColor="#C3D2C3"></stop>
          <stop offset=".84" stopColor="#C3D2C3"></stop>
          <stop offset=".88" stopColor="#C3D2C3" stopOpacity=".78"></stop>
          <stop offset=".96" stopColor="#C3D2C3" stopOpacity=".23"></stop>
          <stop offset="1" stopColor="#C3D2C3" stopOpacity=".01"></stop>
        </linearGradient>
        <linearGradient
